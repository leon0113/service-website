      ...
      <Pressable style={{ backgroundColor: "white", margin: 10 }}>
        ...
        >
          <View>
            ...
            <Text
              style={{ fontSize: 16, fontWeight: "bold", color: "#2AE12A" }}
            >
        ...
        <View style={{ margin: 12 }}>
          ...
          <Text style={{ fontSize: 16, fontWeight: "bold", color: "#2AE12A" }}>
        ...
        >
          <Text style={{ textAlign: "center", color: "white", fontSize: 15, fontWeight: "bold" }}>Go To Home</Text>
        </Pressable>
      </Pressable>
    </View>
  );
