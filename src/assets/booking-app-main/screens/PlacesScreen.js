  ...
  return (
    <View>
      ...
      >
        ...
        >
          <Octicons name="arrow-switch" size={22} color="lightgreen" />
        ...
        <Pressable style={{ flexDirection: "row", alignItems: "center" }}>
          <Ionicons name="filter" size={22} color="lightgreen" />
          <Text style={{ fontSize: 15, fontWeight: "500", marginLeft: 8 }}>
            Filter
          </Text>
        </Pressable>
        ...
        <Pressable onPress={() => navigation.navigate("Map",{
          ...
          <FontAwesome5 name="map-marker-alt" size={22} color="lightgreen" />
          <Text style={{ fontSize: 15, fontWeight: "500", marginLeft: 8 }}>
            Map
          </Text>
        </Pressable>
